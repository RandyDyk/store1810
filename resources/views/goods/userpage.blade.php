...
<body class="g-acc-bg" >
    ...
    <div class="sub_nav marginB person-page-menu">
        <a href="{{url('goods/buyrecord')}}"><s class="m_s1"></s>潮购记录<i></i></a>
        ...
        <a href="{{url('goods/address')}}"><s class="m_s5"></s>收货地址<i></i></a>
...
<div class="footer clearfix">
    <ul>
        ...
        <li class="f_personal"><a href="{{url('goods/userpage')}}" class="hover"><i></i>我的潮购</a></li>
    </ul>
</div>
