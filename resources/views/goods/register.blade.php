        ...
        <div class="registerCon">
            <ul>
                <li class="accAndPwd">
                    ...
                    <dl>
                        <input  type="text" id="code" placeholder="请输入验证码" /><b></b>
...
<script>
    $(function(){
        layui.use(['layer'],function(){
            ...
            //手机号验证
            $(document).on('blur','#userMobile',function(){
                var tel=$(this).val();
                var reg=/^1[34578]\d{9}$/;
                if(!reg.test(tel)){
            ...
            $('.pwd').blur(function(){
                ...
                var reg=/[a-z0-9]{6,16}/;
                if(!reg.test(pwd)){
                    layer.msg('密码由6-16位数组字母组成',{icon:2});
                    type=false;
                }else{
                    layer.msg('正确',{icon:1});
                    type=true;
